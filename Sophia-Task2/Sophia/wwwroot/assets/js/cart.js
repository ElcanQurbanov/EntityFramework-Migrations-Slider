...
for (const minusIcon of minusIcons) {
    minusIcon.addEventListener("click", function () {
        for (const product of products) {
            if (product.id ==
                minusIcon.parentNode.parentNode.getAttribute("data-id")) {
                ...
                minusIcon.parentNode.nextElementSibling.innerText =
...
for (const plusIcon of plusIcons) {
    ...
    plusIcon.addEventListener("click", function () {
        ...
        for (const product of products) {
            if (product.id ==
                plusIcon.parentNode.parentNode.getAttribute("data-id")) {
                ...
                plusIcon.parentNode.nextElementSibling.innerText =
                    product.price * product.count;
            }
        }
